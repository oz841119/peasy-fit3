...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen" onClick={handleClickOutside}>
      {/* Language Switcher */}
      <div className="absolute top-4 right-4 z-10">
        <div className="relative inline-block">
          ...
          >
            ...
            <ArrowUpRight className={`h-3.5 w-3.5 opacity-70 transition-transform ${isOpen ? "rotate-90" : ""}`} />
          </button>
          <div
            className={`absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-gray-900 ring-1 ring-gray-700 overflow-hidden z-50 transition-all duration-200 ${isOpen ? "visible opacity-100" : "invisible opacity-0"}`}
            role="menu"
          >
